...
const EmailSection = () => {
    return (
        <section className="grid md:grid-cols-12 my-12 md:my-16 py-24 gap-4 relative">
            ...
            <div className="col-span-12 z-10 flex flex-col items-center justify-center">
                ...
                <div className="socials flex flex-row gap-2 items-center justify-center">
                    <Link href="https://github.com/BehnamMozafari">
                        <Image src="/github-icon.svg" alt="GitHub" width={40} height={40} />
                    </Link>
                    <Link href="https://www.linkedin.com/in/behnam-mozafari-165506267/">
                        <Image src="/linkedin-icon.svg" alt="LinkedIn" width={40} height={40} />
                    </Link>
                    <a href="mailto:behnammozafari007@gmail.com" className="text-center text-[#ADB7BE] max-w-md underline">
